...
fun main(){
    var s1=Student("Dev","Patel",20,20012011083,"CE","C","AB8")
    var s2=Student("Kathan","Patel",20,20012011101,"CE","B","AB2")
    var s3=Student("Harsh","Maniya",21,20012011059,"CE","C","AB7")
    var s4=Student("Om","Maniya",19,20012021012,"IT","C","AB9")
    var s5=Student("Dhruv","Lakhani",20,20012011055,"AI","C","AB7")
